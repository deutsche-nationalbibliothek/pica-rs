...
Zeitangabe steht. Die Angabe der zu überprüfenden Feder erfolgt mittels
der Option `path`, die eine Pfadausdruck erwartet.
...
werden, wenn die Datums- bzw. Zeitangabe nich am Anfang des zu

...
: Ist die Option gesetzt (`true`) wird die Groß- und Kleinschreibung
beim Vergleichen von Werten ignoriert.
...
: Ist die Option gesetzt (`true`) werden Datensätze gefunden, die
*nicht* dem Filterausdruck entsprechen.

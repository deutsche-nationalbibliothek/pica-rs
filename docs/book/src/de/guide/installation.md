...
```bash
$ wget https://github.com/deutsche-nationalbibliothek/pica-rs/releases/download/v0.15.1/pica_0.15.1-glibc2.31-1_amd64.deb
$ dpkg -i pica_0.15.1-glibc2.31-1_amd64.deb
$ rm pica_0.15.1-glibc2.31-1_amd64.deb
```
...
```bash
$ rpm -i pica-0.15.1-glibc2.31-1.x86_64.rpm
```

Für CentOS 7 steht ein spezielles `RPM`-Paket bereit (`pica-0.15.1-glibc2.17-1.x86_64.rpm`),
...
# Installation der Version 0.15.1
$ cargo install --git https://github.com/deutsche-nationalbibliothek/pica-rs \
      --tag v0.15.1 pica

...
anhand von Kriterien. Filterausdrücke, angewandt auf einem Datensatz,
...
Liste von Felder des Datensatzes angewandt werden. Ein Ausdruck der
...
besteht ein _Field Matcher_ aus einem oder mehreren _Subfield Matcher_,
...
Für die folgenden Beispiele wird eine Unterfeld `x` mit dem Wert
_abcdef_ verwendet:
